...
/**
 * Simple class to create a json string for a given object. The object may be anything. Instances of Map,
 * Collection, Number, String, Boolean are handled in a special way as well as arrays and null references.
 * Any other type is treated as a bean with readable properties to be included in the result (recursively).
 *
 * @author Udo Kastilan
 */
public class Json
{
	...
	/**
	 * Converts a string. Codes larger than 255 are converted to unicode hex sequences.
	 * 
	 * @param sb
	 * @param str
	 */
