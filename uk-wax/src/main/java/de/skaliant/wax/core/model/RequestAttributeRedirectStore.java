 ...
 * as the redirection is another request, and all attributes would be lost otherwise..
 * If a controller returns a redirect result, the dispatcher will copy all
 * request scope attributes into an instance of this class and store it into the session.
 * Before each request, the dispatcher checks for this instance and restores its state.
 *
 * @author Udo Kastilan
 */
public class RequestAttributeRedirectStore
{
	...
	/**
	 * Constructor with a pre-filled map. The map will not be copied, but it
	...
	/**
	 * Sets the content to this map. The map will not be copied, but it
	 * will be used directly.
	 * 
	 * @param attrs
	 */
	...
	/**
	 * Convenience method to save the attributes of a request scope into the session.
	 * 
	 * @param req Request
	 */
