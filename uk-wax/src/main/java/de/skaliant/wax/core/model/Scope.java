...
/**
 * Generalization of a scope as in Application, Session, and Request. I wish Sun
 * would've done this.
 *
 * @author Udo Kastilan
 */
public interface Scope<S> {
	...
	/**
	 * Set an object into the scope. As <code>null</code> values cannot be set
	 * into the scopes, setting a value of <code>null</code> will be treated the
	 * same way as calling {@link #remove(String)}.
	 * 
	 * @param name
	 *          Name
	 * @param value
