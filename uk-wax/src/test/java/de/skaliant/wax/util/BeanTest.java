...
public class BeanTest {
	...
	@Test
	public void findAny() {
		Assert.assertEquals(MiscUtils.createSet("readonly", "writeonly", "readwrite", "class"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.ANY)).keySet());
	}


	@Test
	public void findReadOnly() {
		Assert.assertEquals(MiscUtils.createSet("readonly", "class"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.READ_ONLY)).keySet());
	}


	@Test
	public void findReadable() {
		Assert.assertEquals(MiscUtils.createSet("readonly", "readwrite", "class"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.READABLE)).keySet());
	}


	@Test
	public void findWriteable() {
		Assert.assertEquals(MiscUtils.createSet("writeonly", "readwrite"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.WRITEABLE)).keySet());
	}


	@Test
	public void findReadWrite() {
		Assert.assertEquals(MiscUtils.createSet("readwrite"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.READ_WRITE)).keySet());
	}


	@Test
	public void findWriteOnly() {
		Assert.assertEquals(MiscUtils.createSet("writeonly"),
				Bean.map(Bean.getProperties(AccessibleBean.class, Bean.Accessibility.WRITE_ONLY)).keySet());
	}
}
